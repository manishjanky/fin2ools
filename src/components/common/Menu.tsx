    ...
    return (
        <>
            <nav className={
                ...
                >
                    Deposits
                    <div className='w-full lg:w-48 py-4  px-2 grid lg:group-hover:grid grid-cols-1 lg:hidden lg:absolute top-full left-0 bg-bg-primary lg:border lg:border-border-light rounded-lg lg:shadow-lg gap-4'>
                        <Link
                            to="/deposits/fd"
                ...
                >
                    Mutual Funds
                    <div className='w-full lg:w-48 md:py-6 lg:py-4 grid lg:group-hover:grid grid-cols-1 lg:hidden lg:absolute top-full left-0 bg-bg-primary lg:border lg:border-border-light rounded-lg lg:shadow-lg p-2 gap-4'>
                        <Link
                            to="/mutual-funds"
                            className="transition text-text-secondary hover:text-text-primary lg:border-b border-border-light pb-2"
                        >
