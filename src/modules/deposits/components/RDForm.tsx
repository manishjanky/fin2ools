...
export default function RDForm() {
    ...
    return (
        <div>
            <form className="grid grid-cols-1 md:grid-cols-3 gap-6 border border-primary-lighter p-4 rounded-lg">
                <h2
                    className="text-2xl font-bold text-text-primary col-span-3"
                >
                    RD Calculator
                </h2>
                <div>
                ...
                <div
                    className="rounded-lg p-3 bg-bg-secondary border border-border-light col-span-3"
                >
                    <label
